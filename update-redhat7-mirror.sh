...
/bin/createrepo -p --update -g /data/repos/redhat/rhel-7-server-ansible-2-rpms/comps.xml -o /data/repos/redhat/rhel-7-server-ansible-2-rpms --baseurl=http://mirror.spde.local/redhat/rhel-7-server-ansible-2-rpms /data/repos/redhat/rhel-7-server-ansible-2-rpms
